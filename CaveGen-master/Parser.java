...
class Parser {
    ...
    static String all[] = new String[] {"caveinfo"};
    ...
    void parseAll(CaveGen g) {
        Scanner sc = read("files/" + g.fileSystem + "/" + "caveinfo/caveinfo.txt");
        ...
        sc = read("files/" + g.fileSystem + "/" + "units/" + "units.txt");
